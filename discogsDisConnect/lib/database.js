...
module.exports = function(client){
	...
	database.lookup = function(query, params, callback){
		var obj = {};
		if((arguments.length === 2) && (typeof params === 'function')){
			callback = params;
		}else if(params){
		...
		obj.q = query||'';
		obj.type = 'release';
		console.log(util.addParams('/database/lookup', obj));
		return client.get({url: util.addParams('/database/lookup', obj), authLevel: 1}, callback);
	};
